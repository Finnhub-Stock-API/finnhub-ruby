...
# Unit tests for FinnhubRuby::Estimate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FinnhubRuby::Estimate do
  let(:instance) { FinnhubRuby::Estimate.new }

  describe 'test an instance of Estimate' do
    it 'should create an instance of Estimate' do
      expect(instance).to be_instance_of(FinnhubRuby::Estimate)
    end
  end
