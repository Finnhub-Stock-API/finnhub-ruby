  ...
  class HistoricalNBBO
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FinnhubRuby::HistoricalNBBO` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FinnhubRuby::HistoricalNBBO`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'av')
        if (value = attributes[:'av']).is_a?(Array)
          self.av = value
        end
      end

      if attributes.key?(:'a')
        if (value = attributes[:'a']).is_a?(Array)
          self.a = value
        end
      end

      if attributes.key?(:'ax')
        if (value = attributes[:'ax']).is_a?(Array)
          self.ax = value
        end
      end

      if attributes.key?(:'bv')
        if (value = attributes[:'bv']).is_a?(Array)
          self.bv = value
        end
      end

      if attributes.key?(:'b')
        if (value = attributes[:'b']).is_a?(Array)
          self.b = value
        end
      end

      if attributes.key?(:'bx')
        if (value = attributes[:'bx']).is_a?(Array)
          self.bx = value
        end
      end
    ...
    def hash
      [s, skip, count, total, av, a, ax, bv, b, bx, t, c].hash
    end
